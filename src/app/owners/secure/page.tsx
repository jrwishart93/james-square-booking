...
const EGM_TEAMS_LINK = 'https://teams.live.com/meet/9361186540157?p=3nM4fcihwFSrOLglvH';
  ...
  if (meetingConcluded) {
    return (
      <GlassCard
        title={
          <span className="inline-flex items-center gap-2">
            ...
            <span>Extraordinary General Meeting (EGM)</span>
          </span>
        }
      ...
      >
        ...
        <div className="grid gap-4 text-sm text-slate-700 dark:text-slate-200 md:grid-cols-[160px_1fr]">
          <div className="inline-flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
            <Calendar className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
            <span>Date</span>
          </div>
          <div>Wednesday 21 January 2026</div>
          <div className="inline-flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
            <Clock className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
            <span>Time</span>
          </div>
          <div>From 18:00 (UK time)</div>
          <div className="inline-flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
            <Monitor className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
            <span>Format</span>
          </div>
          <div>Online via Microsoft Teams</div>
          <div className="inline-flex items-center gap-2 font-semibold text-slate-900 dark:text-slate-100">
            <Users className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
            <span>Audience</span>
          </div>
        ...
        <div className="space-y-3">
          <p className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-300">
            <CalendarPlus className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
        ...
        <div className="rounded-2xl p-2 shadow-[0_0_30px_rgba(15,23,42,0.08)] dark:shadow-[0_0_30px_rgba(15,23,42,0.35)]">
          <div className="grid gap-3 sm:grid-cols-2">
            <Link
              href={EGM_TEAMS_LINK}
              target="_blank"
            ...
            >
              <FileText className="h-4 w-4 text-slate-500 dark:text-slate-300" aria-hidden="true" />
              <span>View Newton Property Management information</span>
            </Link>
          </div>
        </div>
