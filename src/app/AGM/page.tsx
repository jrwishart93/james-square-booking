  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-8 text-white sm:px-6 lg:px-8">
      <section className="rounded-2xl border bg-white/10 px-6 py-6 backdrop-blur">
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">AGM 2026</h1>
      ...
      <section className="mt-6 rounded-2xl border bg-white/10 px-6 py-6 backdrop-blur">
        <h2 className="text-2xl font-semibold text-white">James Square – AGM 2026</h2>
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="rounded-xl border border-white/20 bg-white/10 p-4">
            ...
            <p className="mt-2 text-sm text-slate-200">04 June 2026</p>
          </div>
          <div className="rounded-xl border border-white/20 bg-white/10 p-4">
            <div className="flex items-center gap-2 text-sm font-semibold text-slate-100">
            ...
            <p className="mt-2 text-sm text-slate-200">19:00 – 21:00 (GMT)</p>
          </div>
        </div>

        <div className="mt-4 rounded-xl border border-cyan-300/40 bg-cyan-400/10 p-4">
          <p className="text-xs uppercase tracking-wide text-cyan-200">Meeting link</p>
          <a
            href={meetingLink}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex items-center gap-2 rounded-lg bg-cyan-500 px-4 py-2 text-sm font-semibold text-slate-900 shadow"
          >
            Join AGM on Teams
            <ExternalLink className="h-4 w-4" />
          </a>
          <p className="mt-3 break-all text-xs text-slate-200">{meetingLink}</p>
          <button
            type="button"
            onClick={copyMeetingLink}
            className="mt-3 inline-flex items-center gap-2 rounded-lg border border-white/30 bg-white/10 px-3 py-1.5 text-xs font-semibold text-slate-100 hover:bg-white/20"
          >
      ...
      <section className="mt-6 rounded-2xl border bg-white/10 px-6 py-6 backdrop-blur">
        <h2 className="text-2xl font-semibold text-white">Submit an agenda item</h2>
        ...
        <a
          ...
          className="mt-4 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-semibold text-slate-900 shadow hover:bg-slate-100"
        >
